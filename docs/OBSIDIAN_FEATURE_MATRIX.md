...
| Backlinks placeholder | Placeholder panel explains that incoming references are not extracted yet. | Real backlinks panel. | Backlinks feed graph views. | Backlinks support multi-pane reading. | MVP |
